...
def post_update(id):
    articleForUpdate = Article.query.get(id)
    if request.method == "POST":
        articleForUpdate.title = request.form['title']
        articleForUpdate.intro = request.form['intro']
        articleForUpdate.text = request.form['text']
